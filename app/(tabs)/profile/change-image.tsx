...
export default function ChangeProfileImageScreen() {
    ...
    return (<ScreenContainer>
      ...
      <PrimaryButton title="Choose photo" onPress={handlePickImage} loading={loading} disabled={loading}/>
      <Pressable style={({ pressed }) => [styles.removeBtn, pressed && styles.removeBtnPressed]} onPress={handleRemoveImage} disabled={loading}>

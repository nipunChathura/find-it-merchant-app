...
export default function EditProfileScreen() {
    ...
    return (<ScreenContainer>
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <AppInput placeholder="Merchant name" value={merchantName} onChangeText={(t) => { setMerchantName(t); setError(''); }} editable={!loading} style={styles.input}/>
        <AppInput placeholder="Email" value={merchantEmail} onChangeText={(t) => { setMerchantEmail(t); setError(''); }} keyboardType="email-address" autoCapitalize="none" editable={!loading} style={styles.input}/>
        <AppInput placeholder="Phone number" value={merchantPhone} onChangeText={(t) => { setMerchantPhone(t); setError(''); }} keyboardType="phone-pad" editable={!loading} style={styles.input}/>
        ...
        <AppInput placeholder="Merchant type (e.g. SILVER, GOLD, PLATINUM)" value={merchantType} onChangeText={(t) => { setMerchantType(t); setError(''); }} editable={!loading} style={styles.input}/>

...
import { createDiscount, type CreateOrUpdateDiscountPayload, } from '@/services/discountService';
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const data = err && typeof err === 'object' && 'response' in err
                ...
                : undefined;
            setError(typeof data?.responseMessage === 'string' ? data.responseMessage : 'Failed to create discount');
        }
        finally {
            setLoading(false);
        }
    ...
    return (<View style={styles.container}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.typeRow}>
          {DISCOUNT_TYPES.map((type) => (<Pressable key={type} onPress={() => { setDiscountType(type); setError(''); }} style={[
                styles.typeBtn,
        ...
        <AppInput placeholder={discountType === 'PERCENTAGE' ? 'Value (e.g. 15)' : 'Value in LKR (e.g. 100)'} value={discountValue} onChangeText={(t) => { setDiscountValue(t); setError(''); }} keyboardType="decimal-pad" editable={!loading} style={styles.input}/>
        ...
        <PrimaryButton title="Create discount" onPress={handleSave} loading={loading} disabled={loading} style={styles.submitBtn}/>

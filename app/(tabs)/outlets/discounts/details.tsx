...
export default function DiscountDetailsScreen() {
    ...
    const valueText = discount.discountType === 'PERCENTAGE'
    ...
    return (<View style={styles.container}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.heroImageWrap}>
          {discount.discountImage && token ? (<AuthImage type="discount" fileName={discount.discountImage} token={token} style={styles.heroImage} resizeMode="cover"/>) : (<View style={styles.heroPlaceholder}>
        ...
        {(discount.startDate || discount.endDate) ? (<View style={styles.card}>
        ...
        {discount.outletName ? (<View style={styles.card}>
        ...
        {discount.items?.length ? (<View style={styles.card}>
            <View style={styles.cardRow}>
        ...
        <View style={styles.actions}>
          <PrimaryButton title="Edit discount" onPress={() => router.push({
          ...
          <Pressable onPress={() => {
            Alert.alert('Delete discount', `Delete "${discount.discountName ?? 'this discount'}"?`, [

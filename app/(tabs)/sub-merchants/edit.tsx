        ...
        <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
          <View style={styles.card}>
            ...
            <View style={styles.cardInner}>
              ...
              <AppInput placeholder="e.g. Branch A" value={merchantName} onChangeText={(t) => { setMerchantName(t); setError(''); }} editable={!loading} style={styles.input}/>
              <Text style={styles.label}>Email *</Text>
              <AppInput placeholder="e.g. branch@example.com" value={merchantEmail} onChangeText={(t) => { setMerchantEmail(t); setError(''); }} keyboardType="email-address" autoCapitalize="none" editable={!loading} style={styles.input}/>
              <Text style={styles.label}>Phone number *</Text>
              <AppInput placeholder="e.g. 0779876543" value={merchantPhoneNumber} onChangeText={(t) => { setMerchantPhoneNumber(t); setError(''); }} keyboardType="phone-pad" editable={!loading} style={styles.input}/>
              <Text style={styles.label}>Address *</Text>
              <AppInput placeholder="e.g. 50 Branch Rd" value={merchantAddress} onChangeText={(t) => { setMerchantAddress(t); setError(''); }} editable={!loading} style={styles.input}/>
            </View>
          </View>
          ...
          <PrimaryButton title={loading ? 'Saving…' : 'Save changes'} onPress={handleSubmit} loading={loading} disabled={loading}/>
        </ScrollView>

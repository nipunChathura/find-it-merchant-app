...
export default function ForgotPasswordScreen() {
    ...
    return (<ThemedView style={styles.container}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.keyboardView}>
        ...
        <TextInput style={[styles.input, { color: colors.text, borderColor: colors.icon }]} placeholder="Username" placeholderTextColor={colors.icon} value={username} onChangeText={(t) => { setUsername(t); setMessage(''); }} autoCapitalize="none" autoCorrect={false} editable={!loading}/>

        {message ? (<ThemedText style={[styles.message, message.startsWith('If') ? styles.messageSuccess : styles.messageError]}>
            {message}
          </ThemedText>) : null}

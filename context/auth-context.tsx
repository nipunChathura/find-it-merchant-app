...
import { authService, type MainMerchantInfo, type MerchantLoginResponse, type SubMerchantInfo, } from '@/services/authService';
const AUTH_TOKEN_KEY = '@findit_auth_token';
const AUTH_USER_KEY = '@findit_auth_user';
const SECURE_TOKEN_KEY = 'findit_auth_token';
...
export function AuthProvider({ children }: {
    ...
    const login = useCallback(async (username: string, password: string) => {
        ...
        const profilePic = loginRes.profileImageUrl?.trim() ||

...
const statusConfig: Record<OutletStatus, {
    label: string;
    bg: string;
    text: string;
}> = {
...
const currentStatusConfig: Record<CurrentStatus, {
    label: string;
    bg: string;
    text: string;
}> = {
    ...
    const content = (<>
      <View style={styles.main}>
        ...
        <View style={styles.badges}>
          ...
          {currentStatusStyle ? (<View style={[styles.badge, { backgroundColor: currentStatusStyle.bg }]}>

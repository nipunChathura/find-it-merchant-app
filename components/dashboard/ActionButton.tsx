...
export function ActionButton({ label, icon, onPress, primary = false, }: ActionButtonProps) {
    return (<Pressable onPress={onPress} style={({ pressed }) => [
      ...
      <View style={[styles.iconWrap, primary ? styles.iconWrapPrimary : styles.iconWrapSecondary]}>
        <MaterialIcons name={icon} size={22} color={primary ? colors.white : colors.primary}/>
      </View>
      <Text style={[
            styles.label,

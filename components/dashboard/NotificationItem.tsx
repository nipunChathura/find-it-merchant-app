...
export function NotificationItem({ notification, onReadPress }: NotificationItemProps) {
    ...
    return (<View style={[
      ...
      <View style={[
        ...
        <MaterialIcons name="notifications" size={20} color={notification.read ? colors.textSecondary : colors.accent}/>
      </View>
      ...
      {showRead ? (<Pressable accessibilityRole="button" accessibilityLabel="Mark notification as read" onPress={() => onReadPress?.(notification)} style={({ pressed }) => [styles.readBtn, pressed && styles.readBtnPressed]}>
